...
public class Vertices {
	...
	public Vertices(int maxVertices, int maxIndices, boolean hasColor, boolean hasTexCoords, boolean hasNormals)  {
		this(maxVertices, maxIndices, hasColor, hasTexCoords, hasNormals, false );  // Call Overloaded Constructor
	}
...
//		this.numVertices = length / positionCnt;
...
//		Log.v(TAG, "when begining bind " + GLES20.glGetError());
...
//		Log.v(TAG, "when finishing bind " + GLES20.glGetError());
